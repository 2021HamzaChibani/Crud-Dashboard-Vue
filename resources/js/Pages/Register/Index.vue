<template>
        <div class="min-h-full flex flex-col justify-center py-12 sm:px-6 lg:px-8">
            <div class="sm:mx-auto sm:w-full sm:max-w-md">
                <img class="mx-auto h-12 w-auto" src="../../images/dashboard-interface.png" alt="Workflow" />
                <h2 class="mt-6 text-center text-3xl font-extrabold text-gray-900">
                    Sign up
                </h2>
                <p class="mt-2 text-center text-sm text-gray-600">
                    Beheer je eigen klanten systeem
                </p>
            </div>
                ...
                <div class="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
                    <form @submit.prevent="createUser" method="post">
                        <div>
                            ...
                            <div class="mt-1">
                                <input id="username" v-model="form.name" name="username" type="text" autocomplete="email" required="" class="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" />
                            </div>
                        </div>
