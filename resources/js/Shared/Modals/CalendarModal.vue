                ...
                <form>
                    <div class="flex justify-between border-b border-gray-100 px-5 py-4">
                        <div>
                            ...
                            <span class="font-bold text-gray-700 text-lg">Afspraak aanmaken</span>
                        </div>
                        <div>
                            <button>
                                <i
                        ...
                        <div class>
                            ...
                            <div class="mb-4">
                                ...
                                <input
                                    ...
                                    placeholder="Voer de reden voor de zoekopdracht in"
                                    autocomplete="off"
                                />
                    ...
                    <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                        <button
                            ...
                            type="button"
                            class="inline-flex justify-center w-full border border-blue-500 bg-blue-500 text-white rounded-md px-4 py-2 m-2 transition duration-500 ease select-none hover:bg-blue-600 focus:outline-none focus:shadow-outline"
                        >Save</button>
                        <button
                            type="button"
